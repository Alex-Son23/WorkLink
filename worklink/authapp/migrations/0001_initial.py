    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('сосискатель', 'сосискатель'), ('компания', 'компания')], max_length=16, verbose_name='статус пользователя')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('greeting_letter', models.CharField(max_length=512, verbose_name='приветственное письмо')),
