# Generated by Django 4.1.7 on 2023-04-19 08:45
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('ожидание ответа', 'Ожидание ответа'), ('принято', 'Приглашение'), ('отказ', 'Отказ')], default='ожидание ответа', max_length=128, verbose_name='статус')),
            ],
        ),
        migrations.CreateModel(
            name='Vacancy',
